...
st.write("""
          ...
          ```
          =XLOOKUP($A4&"-"&RIGHT(D$3, 1), 'Lidl AV Raw Data.csv'!$AE:$AE, 'Lidl AV Raw Data.csv'!$Q:$Q)
          ```
          ```
          =UPPER(XLOOKUP($A4&"-"&RIGHT(D$3, 1), 'Lidl AV Raw Data.csv'!$AE:$AE, 'Lidl AV Raw Data.csv'!$Y:$Y))
          ```
