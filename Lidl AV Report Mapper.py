...
st.write("""
          ...
          ```
          =XLOOKUP($A4&"-"&RIGHT(D$3, 1), 'Lidl AV Raw Data.csv'!$AF:$AF, 'Lidl AV Raw Data.csv'!$Q:$Q)
          ```
          ```
          =UPPER(XLOOKUP($A4&"-"&RIGHT(D$3, 1), 'Lidl AV Raw Data.csv'!$AF:$AF, 'Lidl AV Raw Data.csv'!$Y:$Y))
          ```
